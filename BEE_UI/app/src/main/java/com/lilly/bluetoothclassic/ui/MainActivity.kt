...
import com.lilly.bluetoothclassic.util.PERMISSIONS
import com.lilly.bluetoothclassic.util.REQUEST_ALL_PERMISSION
...
class MainActivity : AppCompatActivity() {
    ...
    var msg = ""
    var reset = "r"
    var sound1: MediaPlayer? = MediaPlayer.create(this, R.raw.alarm)
    var sound2: MediaPlayer? = MediaPlayer.create(this, R.raw.soundsiren)
